...
@NonNullApi
public class EasyPosProjectDependency extends DelegatingProjectDependency {

    @Inject
    public EasyPosProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
